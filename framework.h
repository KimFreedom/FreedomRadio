...
#define CHANNEL_STATIC_WIDTH    20
#define CHANNEL_STATIC_HEIGHT   15
#define CHANNEL_EDIT_WIDTH      68
#define CHANNEL_EDIT_HEIGHT     15
#define CHANNEL_CONTROL_MARGIN  2
#define CHANNEL_CONTROL_PADDING 5

#define CHANNEL_MARGIN          2
#define CHANNEL_WIDTH           (CHANNEL_CONTROL_PADDING * 2) + CHANNEL_STATIC_WIDTH + CHANNEL_CONTROL_MARGIN + CHANNEL_EDIT_WIDTH
